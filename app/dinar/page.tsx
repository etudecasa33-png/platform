...
export default function DinarPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {/* Table Area (MOBILE RESPONSIVE FIX APPLIED HERE) */}
        ...
        <table className="w-full text-left min-w-[800px]">
          <thead className="bg-gray-50 text-gray-600 border-b border-gray-200">
            <tr>
              ...
              <th className="p-4 font-medium text-right whitespace-nowrap">Amount (DZD)</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {transactions.map((t) => (
              <tr key={t.id} className="text-gray-800 hover:bg-gray-50 transition-colors">
                ...
                <td className={`p-4 text-right font-bold whitespace-nowrap ${t.type === 'ENTREE' ? 'text-green-600' : 'text-red-600'}`}>
